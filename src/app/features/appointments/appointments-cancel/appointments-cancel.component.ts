...
@Component({
  selector: "app-appointments-cancel",
  templateUrl: "./appointments-cancel.component.html",
  styleUrls: ["./appointments-cancel.component.scss"]
})
export class AppointmentsCancelComponent implements OnInit {
   ...
   */
  ngOnInit() {
    this.getAllAppointmentsButCancel();
    this.getCurrentUser();
  }
   ...
   * @param {User} user
   * @returns
   * @memberof AppointmentsCancelComponent
   */
